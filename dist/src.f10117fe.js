...
function () {
  function Model(attributes, sync, events) {
    ...
    this.sync = sync;
    this.events = events; // Much shorter than the accessors below
...
function () {
  function Eventing() {
    ...
    this.on = function (eventType, callback) {
      var handlers = _this.events[eventType] || [];
      handlers.push(callback);
      _this.events[eventType] = handlers;
    };
    /***
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function buildUser(attrs) {
      return new User(new Attributes_1.Attributes(attrs), new ApiSync_1.ApiSync(ROOT_URL), new Eventing_1.Eventing());
    }
  }, {
    key: "buildUserCollection",
    value: function buildUserCollection() {
      return new Collection_1.Collection(ROOT_URL, function (json) {
...
var UserForm = /*#__PURE__*/function () {
  ...
  _createClass(UserForm, [{
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        ...
        fragment.querySelectorAll(selector).forEach(function (element) {
          return element.addEventListener(eventType, eventsMap[eventKey]);
        });
      };
    ...
    value: function render() {
      ...
      this.parent.append(templateElement.content); // Append template to the parent
    }
  }]);
...
},{"./models/User":"src/models/User.ts","./views/UserForm":"src/views/UserForm.ts"}],"C:/Users/ynsdi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/ynsdi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
